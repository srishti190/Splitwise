...
public class ExactExpense extends Expense{
    ...
    public ExactExpense(Double totalAmount, User paidBy, User addedBy, List<Split> splitList, String expenseName) throws IllegalSplitException {
        super(totalAmount, ExpenseType.EXACT, paidBy, addedBy, splitList, expenseName);
    }
